...
int main(){   
    ...
    int lagOffset = 2; //any connection to the changes in initial offset for the mid and north fountains? negative 2 default, varies with rng seed at start.
